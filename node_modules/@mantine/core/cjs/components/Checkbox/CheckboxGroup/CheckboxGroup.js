...
const CheckboxGroup = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("CheckboxGroup", defaultProps, props), {
    children,
    value,
    defaultValue,
    onChange,
  ...
  const checkboxes = filterChildrenByType.filterChildrenByType(children, Checkbox.Checkbox).map((checkbox, index) => React.cloneElement(checkbox, {
    key: index,
